...
<body class="text-light bg-dark bg-gradient">
    ...
    <main>
        <div class="col-lg-12">
            <h1 class="fw-bolder text-center" id="project-title">Reproductor MP3</h1>
        </div>
                ...
                <div class="row">
                                ...
                                <li class="list-group-item list-group-item-action item" data-id="<?= $row['id'] ?>">
                                    <div class="d-flex w-100 align-items-center">
                                        <div class="col-auto pe-2">
                                            <img src="<?= is_file(explode("?",$row['image_path'])[0]) ? $row['image_path'] : "./images/Audi.png" ?>" alt="" class="img-thumbnail bg-gradient bg-dark mini-display-img">
                                        </div>
                 ...
                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="col-md-12 text-center">
                            <img src="./images/Audi.png" alt="" id="display-img" class="img-fluid border bg-gradient bg-dark">
                        </div>
                    ...
                    <div class="container-fluid">
                        <form action="" id="music-form">
                            ...
                            <div class="form-group mb-3 text-center">
                                <div class="col-md-6">
                                <img src="./images/Audi.png" alt="Image" class="img-fluid img-thumbnail bg-gradient bg-dark" id="dImage">
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form action="" id="update-music-form">
                            ...
                            <div class="form-group mb-3 text-center">
                                <div class="col-md-6">
                                <img src="./images/Audi.png" alt="Image" class="img-fluid img-thumbnail bg-gradient bg-dark" id="dImage2">
                                </div>
                            </div>
                        </form>
                    </div>
